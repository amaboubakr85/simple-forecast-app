                    ...
                    <Row>
                        <Col lg={12} md={12} sm={12}>
                            <div className="head">
                                ...
                                <img src={`http://openweathermap.org/img/wn/${cityWeather.current.weather[0].icon}@2x.png`} alt="weather icon"/>
                                <Row className="mt-2">
                                    <Col md={3} lg={3} sm={3}><span className='fw-bold'>Clouds:</span>{cityWeather.current.clouds}</Col>
                                    <Col md={3} lg={3} sm={3}><span className='fw-bold'>humidity:</span>{cityWeather.current.humidity}</Col>
                                    <Col md={3} lg={3} sm={3}><span className='fw-bold'>pressure:</span>{cityWeather.current.pressure}</Col>
                                    <Col md={3} lg={3} sm={3}><span className='fw-bold'>Temperature:</span>{cityWeather.current.temp}</Col>
                                </Row>
                            </div>
